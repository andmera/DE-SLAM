...
if(NOT "include;/usr/include/eigen3;/usr/include/opencv;/usr/include;/home/odroid/workspace/Sophus " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'svo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/catkin_ws/install/${idir}'.  Ask the maintainer 'Christian Forster <forster@ifi.uzh.ch>' to fix it.")
    endif()
